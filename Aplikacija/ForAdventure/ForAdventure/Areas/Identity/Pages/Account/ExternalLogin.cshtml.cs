...
namespace ForAdventureWeb.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null, IFormFile? file = null)
        {
            returnUrl = returnUrl ?? Url.Content("~/");
            ...
            if (ModelState.IsValid)
            {
                ...
                user.NameInApplication = Input.NameInApplication;
                ...
                if (file != null)
                {
                    ...
                    user.ImageURL = @"\images\profilePicture\" + fileName + extension;
                }
